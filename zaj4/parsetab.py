...
_lr_productions = [
  ...
  ('command -> OPERATE NUMBER article','command',3,'p_command','eliza.py',77),
  ('attribute -> COLOR','attribute',1,'p_attribute_color','eliza.py',95),
  ('attribute -> MATERIAL','attribute',1,'p_attribute_material','eliza.py',100),
  ('attribute -> SIZE','attribute',1,'p_attribute_size','eliza.py',105),
  ('article -> KIND','article',1,'p_article_kind','eliza.py',110),
  ('article -> attribute article','article',2,'p_article_attribute','eliza.py',115),
]
